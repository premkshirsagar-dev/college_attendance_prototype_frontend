// pages/auth/TeacherRegister.jsx
...
const TeacherRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/login/teacher"), 1200);
    } catch (err) {
      setMessage({
        type: "error",
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 px-4 py-10">
      <div className="bg-white shadow-md rounded-2xl p-8 w-full max-w-md border border-slate-200">
        <h1 className="text-2xl font-bold text-brand-700 mb-1">Teacher Registration</h1>
        <p className="text-slate-500 text-sm mb-6">Create your teacher account</p>
        ...
        <p className="text-sm text-slate-500 mt-5 text-center">
          ...
          <Link to="/login/teacher" className="text-brand-600 font-medium">Login here</Link>
        </p>
